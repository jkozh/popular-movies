...
public class FetchFavoritesTask extends AsyncTask<Void, Void, List<Movie>> {
    ...
    public FetchFavoritesTask(Context context, MovieGridAdapter adapter, ArrayList<Movie> movies) {
        mContext = context;
